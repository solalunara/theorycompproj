...
\section{Methodology}
    ...
    \subsection{Poincar\'e Sections}
        ...
        propagated forward through the equation of motion.\\
    \subsection{Bifurcation Diagrams}
        ...
        created for both the angle of the system and the angular velocity, and were made using a 2d histogram on a log scale of counts\\
    ...
    \subsection{Lyapunov Exponent}
        The Lyapunov exponent is a measure of the sensitivity to initial conditions of a system. The Lyapunov exponent is calculated by
        taking the derivative of the system with respect to the initial condition and then taking the logarithm of the absolute value of
        the derivative. The Lyapunov exponent is then the average of this value over time. The Lyapunov exponent is a useful tool for 
        determining the sensitivity to initial conditions of a system, and can be used to determine whether or not a system is chaotic.\\
